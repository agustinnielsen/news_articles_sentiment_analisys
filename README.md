...
This repository contains a modular Python-based pipeline designed to automate the extraction of web news articles, sentence-level linguistic segmentation, and subsequent sentiment analysis using Small Language Models (SLMs) via the Groq API.
...
```bash
git clone https://github.com/agustinnielsen/news_articles_sentiment_analisys.git
cd news_articles_sentiment_analisys
